...
<body>
  ...
  <header>
    <div class="logo">
      <h2><a href="http://blog-2025-linux.test">Blog-2025 </a></h2>
    </div>
    <nav>
      <ul><?php
          switch (true) {
          ...
          ?><li><a id="gcu" href="logout.php">Se déconnecter</a></li>
            <li><a id="gcu" href="admin.php">Dashboard Admin</a></li><?php
                                                                      break;

                                                                    case isset($_SESSION['auth']):
                                                                      ?><li><a id="gcu" href="logout.php">Se déconnecter</a></li><?php
                                                                                                                                  break;

                                                                                                                                default:
                                                                                                                                  ?><li><a id="lien-header" href="register.php">S'inscrire</a></li>
            <li><a href="login.php">Se connecter</a></li><?php
                                                                                                                                  break;
                                                                                                                              }
                                                          ?>
      </ul>
